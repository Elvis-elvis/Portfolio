...
import com.ruberwa.myportfolio2.auth0.models.*;
...
public class Auth0WebClient implements Auth0Service {
    ...
    @Override
    public Mono<UserResponseModel2> getUserById(String auth0UserId) {
        ...
        return getAccessToken()
                .flatMap(token -> {
                    ...
                    return Mono.zip(userMono, rolesFlux.collectList(), permissionsFlux.collectList())
                            .map(tuple -> mapToUserResponseModel2(auth0UserId, tuple.getT1(), tuple.getT2(), tuple.getT3()));
                })
    ...
    private UserResponseModel2 mapToUserResponseModel2(
            String auth0UserId,
        ...
        return UserResponseModel2.builder()
